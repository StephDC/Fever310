...
train_labels   = read.csv('~/DS310 Dengue/Data/residualPositive.csv')
...
preprocessData(data_path = '~/DS310 Dengue/Data/dengue_features_train.csv', labels_path = '~/DS310 Dengue/Data/residualPositive.csv') -> trains
